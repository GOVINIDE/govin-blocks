...
//CARES
Blockly.Python['control_wait_micropython'] = function(block) {
  var arg0 = Blockly.Python.valueToCode(block, 'DURATION',
      Blockly.Python.ORDER_FUNCTION_CALL);
...
//CARES
Blockly.Python['arduino_loop'] = function(block) {
...
Blockly.Python['control_elif'] = function(block) {
  var argument = Blockly.Python.valueToCode(block, 'CONDITION',
      Blockly.Python.ORDER_NONE) || 'False';
  var branch = Blockly.Python.statementToCode(block, 'SUBSTACK');
  branch = Blockly.Python.addLoopTrap(branch, block.id);
...
Blockly.Python['control_else'] = function(block) {
  var argument = Blockly.Python.valueToCode(block, 'CONDITION',
      Blockly.Python.ORDER_NONE) || 'False';
  var branch = Blockly.Python.statementToCode(block, 'SUBSTACK');
  branch = Blockly.Python.addLoopTrap(branch, block.id);

  var code = "else " + argument + ":\n";
  if (branch) {
    code += branch;
  } else {
    code += Blockly.Python.INDENT + "pass\n";
